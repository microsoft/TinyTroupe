...
TEMP_SIMULATION_CACHE_FILE_NAME = os.path.join(
    os.path.dirname(__file__), "simulation_test_case.cache.json"
)
...
if conftest.use_cache:
    litellm_utils.force_api_cache(True, CACHE_FILE_NAME)
else:
    litellm_utils.force_api_cache(False, CACHE_FILE_NAME)
...
def create_test_system_user_message(
    user_prompt, system_prompt="You are a helpful AI assistant."
):
    """

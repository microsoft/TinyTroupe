...
class TinyPersonFactory(TinyFactory):
    ...
    def _initialize_sampling_plan_transaction(self, n, description, context):
        ...
        if self.remaining_characteristics_sample is None:
            ...
            logger.debug(f"Sampling dimensions: {_safe_json_dumps(self.sampling_dimensions)}")
            ...
            logger.debug(f"Sampling plan: {_safe_json_dumps(self.sampling_plan)}")
            ...
            logger.debug(f"Remaining characteristics sample: {_safe_json_dumps(self.remaining_characteristics_sample)}")

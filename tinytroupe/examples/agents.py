...
def create_oscar_the_architect_2():
    ...
    oscar.define(
        "behaviors",
        {"routines": ["Every morning, you wake up, feed your dog, and go to work."]},
    )
    oscar.define(
        "occupation",
        {
...
def create_lisa_the_data_scientist_2():
    ...
    lisa.define(
        ...
        [
            ...
            {
                "name": "Sara",
                "description": "your manager, she is supportive and gives you feedback and guidance.",
            },
            {
                "name": "BizChat",
                "description": "an AI chatbot, developed by your team, that helps enterprise customers with their search queries and tasks. You often interact with it to test its performance and functionality.",
            },
        ],
    )
...
def create_marcos_the_physician_2():
    ...
    marcos.define(
        ...
        [
            ...
            {
                "name": "Luna and Sol",
                "description": "your cats, they are very cute and playful.",
            },
            {
                "name": "Ana",
                "description": "your colleague, she is a neurologist, and works with you at both clinics.",
            },
            {
                "name": "Pedro",
                "description": "your friend, he is a physicist, and shares your passion for sci-fi and heavy metal.",
            },
        ],
    )
...
def create_lila_the_linguist_2():
    ...
    lila.define(
        ...
        {
            "routines": [
                "Every morning, you wake up, make yourself a cup of coffee, and check your email."
            ]
        },
    )
    lila.define(
